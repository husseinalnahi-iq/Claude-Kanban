    ...
    features: [
      {
        ...
        pitch: "Supervised turns every write into an Allow / Deny card. Autonomous works in its own git worktree. Supervised can have its own branch too, landing only when you approve.",
      ...
      },
      {
        ...
        icon: "✓",
        color: "var(--color-iris)",
        title: "Approve the plan before any code",
        pitch: "Turn on plan approval and every task waits after its Plan stage: read it, approve it, edit it, or send it back with a note.",
        why: "A wrong plan is cheapest to fix before a line is written. Mark a task “touches a live system” (a prod chip) and it always waits, every stage is told to dry-run and read back each live change, and the review runs on your strongest model.",
        where: "Settings → Runs & limits · a task's Pipeline tab · its Plan tab",
        go: "settings",
      },
      {
        id: "landing",
